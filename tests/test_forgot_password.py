...
2-user should be able to send forgot password request with inactive email
3-unverified should bot be able to request forgot password email
4-inactive should bot be able to request forgot password email
"""
